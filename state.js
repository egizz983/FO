...
window.farmingState = {
    ...
    market: {
        day: [
            ...
            new MarketUpgrade({ index: 4,  name: "Nutritious Soil",     calcType: "linear",     param: 1,  isMultiplier: false, unit: "%",       currentLevel: 0, perLevel: false, description: "+(1%/Lvl) growth speed for all land.", group: "GrowthSpeed" }),
