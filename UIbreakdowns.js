...
window.getFarmingBreakdowns = function() {
    return {
        "Evolution": [
            ...
            { label: "Achievement", value: "×" + (5 * (window.farmingState.achievements.farmingEvoLilOvergrowth === -1 ? 1 : 0)).toMulti().toFixed(2) },
            { label: "KillRoy", value: "×" + getKillroyBonus().toFixed(2)},
